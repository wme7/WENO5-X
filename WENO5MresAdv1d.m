function res = WENO5MresAdv1d(w,flux,dflux,S,dx)
% *************************************************************************
...
% Constants
d0n = 1/10; d1n = 6/10; d2n = 3/10; epsilon = 1e-40;
...
% Mapping functions
g0n = w0n.*(d0n+d0n*d0n-3*d0n*w0n+w0n.^2) ./ (d0n*d0n + w0n*(1-2*d0n));
g1n = w1n.*(d1n+d1n*d1n-3*d1n*w1n+w1n.^2) ./ (d1n*d1n + w1n*(1-2*d1n));
g2n = w2n.*(d2n+d2n*d2n-3*d2n*w2n+w2n.^2) ./ (d2n*d2n + w2n*(1-2*d2n));
gsumn = g0n+g1n+g2n;
...
% Constants
d0p = 3/10; d1p = 6/10; d2p = 1/10; epsilon = 1e-40;
...
% Mapping functions
g0p = w0p.*(d0p+d0p*d0p-3*d0p*w0p+w0p.^2) ./ (d0p*d0p + w0p*(1-2*d0p));
g1p = w1p.*(d1p+d1p*d1p-3*d1p*w1p+w1p.^2) ./ (d1p*d1p + w1p*(1-2*d1p));
g2p = w2p.*(d2p+d2p*d2p-3*d2p*w2p+w2p.^2) ./ (d2p*d2p + w2p*(1-2*d2p));
gsump = g0p+g1p+g2p;
